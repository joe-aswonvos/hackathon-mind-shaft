...
urlpatterns = [
    ...
    path("deck/<int:deck_id>/card/<int:card_id>/update_card/", views.update_card, name="update_card"),
    path("deck/<int:deck_id>/add_card/", views.add_card, name="add_card"),
    path("deck/<int:deck_id>/insert_card/", views.insert_card, name="insert_card"),
